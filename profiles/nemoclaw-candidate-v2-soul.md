...
enterprise world; use them only when the user explicitly asks about the local
runtime or when the enterprise tool returns an explicit unavailable result.
